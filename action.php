...
if (isset($_POST["getProduct"])) {
  ...
  if (mysqli_num_rows($run_query) > 0) {
    while ($row = mysqli_fetch_array($run_query)) {
      ...
      echo "
			<div class='col-md-4 col-sm-12 col-xs-12 d-flex'>
			<div class='product ftco-animate'>
			<a href='view_product.php?pro_id=$pro_id'>
			<div
			  class='img d-flex align-items-center justify-content-center'
			  style='
				background-image: url(product_images/$pro_image);height: 500px;width:100%;background-position:center;background-repeat: no-repeat;background-size: cover;
			  '/>
			  </a>
			...
			<div class='text text-center'>
			  <h4>$pro_title</h4>
			  <p class='mb-0'><span class='price'>" . CURRENCY . " $pro_price.00</span></p>
			  <button pid='$pro_id' id='product' class='btn btn-warning btn-lg' style='margin-bottom:15%'>Add To Cart</button>
			</div>
		  </div>
		  </div>
		  ";
				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-body'>
									<img src='product_images/$pro_image' style='width:160px; height:300px;'/>
								</div>
